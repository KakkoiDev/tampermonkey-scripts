...
Notes for building Tampermonkey userscripts against Slack's web app (`app.slack.com`), learned while building [`slack-auto-remove-preview.user.js`](../slack-auto-remove-preview.user.js). Iterate with the [live-reload loop](../DEVELOPMENT.md).
